...
- (BOOL)isERCTokenStandartInterface:(NSArray*) interface {
    ...
    NSArray* qrc20interface = [self getHRC20TokenStandartAbiInterface];
    return [self isInterfaceArray:interface equalHRC20InterfaceArray:qrc20interface];
}
...
-(BOOL)isInterfaceArray:(NSArray*)intefaceArray equalHRC20InterfaceArray:(NSArray*)qrc20 {
